import { ClipboardPlus, MessageCircle, Phone } from 'lucide-react';
import { Link } from '@/i18n/routing';

export function FinalCTA() {
  return (
    <section className="relative overflow-hidden bg-[#0D3B73] px-6 py-[72px] text-center">
      <div
      ...
      <div className="relative z-[1] mx-auto max-w-[520px]">
        ...
        <h2 className="mb-2.5 text-[30px] font-semibold leading-[1.2] text-white">
          Besoin d&apos;une offre pour votre établissement ?
        </h2>
        <p className="mb-9 text-[14px] leading-[1.7] text-[rgba(255,255,255,0.6)]">
          Décrivez vos besoins — nous vous répondons directement avec un devis adapté à vos
          volumes et votre activité.
        </p>
        ...
        <p className="mt-4 flex items-center justify-center gap-1 text-[12px] text-[rgba(255,255,255,0.4)]">
          <Phone className="h-[13px] w-[13px]" aria-hidden />
          Ou appelez directement : 71 758 468
        </p>
      </div>
    </section>
  );
