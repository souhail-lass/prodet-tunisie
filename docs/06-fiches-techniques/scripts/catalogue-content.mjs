...
export const FAMILIES = {
  ...
  deofreshLinge: {
    ...
    dosage:
      "Environ 20 à 30 ml par cycle de lavage, à ajuster selon la charge et l'intensité souhaitée.",
  },
  insecticide: {
  ...
  lessivePoudre: {
    ...
    dosage:
      "Environ 8 à 15 g par kg de linge sec, à ajuster selon la salissure et la dureté de l'eau.",
  },
  lessiveLiquide: {
    ...
    dosage:
      "Environ 10 à 20 ml par kg de linge sec, à ajuster selon la salissure et la dureté de l'eau.",
  },
  lessiveDelicat: {
  ...
  javelLiquide: {
    ...
    dosage:
      "Surfaces : environ 250 ml pour 10 L d'eau. Linge blanc : suivre les préconisations de la machine.",
  },
  detacheur: {
  ...
  lavageMachine: {
    ...
    dosage:
      "Réglage de la pompe doseuse selon la dureté de l'eau, généralement 1 à 3 ml par litre d'eau de lavage.",
  },
  rincage: {
  ...
  chloreP: {
    ...
    dosage:
      "Nombre de pastilles selon le volume d'eau et la concentration recherchée, se référer à l'étiquette.",
  },
  poudreRecurer: {
  ...
  desinfectantMulti: {
    ...
    dosage:
      "Se référer aux préconisations de l'étiquette selon le niveau de désinfection recherché.",
  },
  ...
  sacBretelle: {
    ...
    howToUse:
      'Charger sans dépasser la contenance prévue pour préserver la résistance des poignées.',
  },
  sacCongelation: {
  ...
  brosse: {
    ...
    howToUse:
      'Utiliser avec la solution de nettoyage adaptée. Rincer et laisser sécher après usage.',
  },
  brosseWc: {
...
export const ASSIGNMENTS = [
  ...
  [
    ...
    'airfresh',
    [
      ['Conditionnement', 'Aérosol 300 ml'],
      ['Parfum', 'Glade'],
    ],
  ],
  [
  ...
  [
    ...
    'papierHygienique',
    [
      ['Conditionnement', 'Sac de 12 rouleaux'],
      ['Format', 'Jumbo T2, mandrin 70'],
    ],
  ],
  [
    'P-00007',
    'papierHygienique',
    [
      ['Conditionnement', 'Lot de 48 rouleaux'],
      ['Qualité', 'Ultra doux'],
    ],
  ],
  ...
  [
    ...
    'serviettesTable',
    [
      ['Conditionnement', 'Carton de 24 paquets'],
      ['Format', '30 x 30 cm'],
    ],
  ],
  [
    ...
    'serviettesTable',
    [
      ['Conditionnement', 'Carton de 20 paquets'],
      ['Format', 'Enchevêtrées'],
    ],
  ],
  [
  ...
  [
    ...
    'chiffon',
    [
      ['Conditionnement', 'Lot de 20'],
      ['Type', 'Cachemire blanc'],
    ],
  ],
  [
    'P-00011',
  ...
  [
    ...
    'pelle',
    [
      ['Conditionnement', 'Pelle et balai'],
      ['Format', 'Grand modèle'],
    ],
  ],
  [
