// Prodet initial web catalog — extracted from LISTE DE PRIX 2025 OFF.xls
// Prices intentionally removed. Verify names/units/dosages before public launch.

export type ProdetCatalogProduct = {
  name: string;
  usages: string[];
  variants: { unit?: string; dosage?: string }[];
  sourceLines?: number[];
};

export type ProdetCatalogSection = {
  id: string;
  label: string;
  description: string;
  ctaLabel: string;
  products: ProdetCatalogProduct[];
};
